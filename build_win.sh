...
wine $LOCAL_MINGW_HOME/bin/gcc -Wall -c -mrtd -D_JNI_IMPLEMENTATION -I$LOCAL_JAVA_HOME/include -I$LOCAL_JAVA_HOME/include/win32 *.c 
wine $LOCAL_MINGW_HOME/bin/gcc -Wall -Wl,-kill-at -shared -o $dist_name.dll *.o -Llib -lWintab32 
